...
void fwrite_char (CHAR_DATA * ch, FILE * fp)
{
	...
	fprintf (fp, "Lord         %s~\n", ch->lord);
	fprintf (fp, "Bloodline    %s~\n", ch->bloodline);
	fprintf (fp, "Kithname   %s~\n", ch->kithname);
	fprintf (fp, "Auspice      %s~\n", ch->auspice);
	fprintf (fp, "Courtname      %s~\n", ch->courtname);
	fprintf (fp, "Side         %s~\n", ch->side);
	fprintf (fp, "Virtue       %s~\n", ch->virtue);
	fprintf (fp, "Vice         %s~\n", ch->vice);
	fprintf (fp, "Lodge        %s~\n", ch->lodge);
...
//	fprintf (fp, "Canvotecounter %d\n", ch->pcdata->canvotecounter);
	fprintf (fp, "CovenantStatus %d\n", ch->pcdata->covenantstatus);
	...
	{
		fprintf (fp, "Po           %d\n", ch->pcdata->po);
		fprintf (fp, "ShortDescL   %s~n", ch->pcdata->urhandescshort);
		fprintf (fp, "ShortDescC   %s~n", ch->pcdata->gaurudescshort);
		fprintf (fp, "ShortDescH   %s~n", ch->pcdata->urshuldescshort);
		fprintf (fp, "ShortDescG   %s~n", ch->pcdata->daludescshort);
		fprintf (fp, "UrhanDesc    %s~\n", ch->pcdata->urhandesc);
		fprintf (fp, "GauruDesc    %s~\n", ch->pcdata->gaurudesc);
		fprintf (fp, "UrshulDesc   %s~\n", ch->pcdata->urshuldesc);
		fprintf (fp, "DaluDesc     %s~\n", ch->pcdata->daludesc);
		fprintf (fp, "MLongDesc    %s~\n", ch->pcdata->mlongdesc);
		fprintf (fp, "TempDesc     %s~\n", ch->pcdata->tempdesc);
		fprintf (fp, "Biography    %s~\n", ch->pcdata->biography);
		...
		fprintf (fp, "CotBloodlines%s~\n", ch->pcdata->cot_bloodlines);
		...
		fprintf (fp, "Wolf         %d\n", ch->pcdata->wolf);
		fprintf (fp, "Rank         %d\n", ch->pcdata->rank);
		fprintf (fp, "Virtues      %d %d %d\n", ch->pcdata->virtues[VIRTUE_CITYSTATUS], ch->pcdata->virtues[VIRTUE_COVSTATUS], ch->pcdata->virtues[VIRTUE_CLANSTATUS]);	
		fprintf (fp, "Courtname   %d\n", ch->pcdata->courtname);
		if (IS_CHANGELING(ch))
		{
			fprintf (fp, "Harmony   %d %d\n", ch->pcdata->harmony[HARMONY_CURRENT], ch->pcdata->harmony[HARMONY_MAX]);
			fprintf (fp, "HarmonyBank  %d\n", ch->pcdata->harmony_bank);
			fprintf (fp, "Virtues      %d %d %d %d %d", ch->pcdata->virtues[VIRTUE_CITYSTATUS], ch->pcdata->virtues[VIRTUE_COVSTATUS], ch->pcdata->virtues[VIRTUE_CLANSTATUS], ch->pcdata->virtues[VIRTUE_VISION], ch->pcdata->virtues[VIRTUE_MANTLE]);
		}
		...
		fprintf (fp, "Atm          %d\n", ch->pcdata->atm);
		fprintf (fp, "Eternalsummer      %d\n", ch->pcdata->eternalsummer);
		fprintf (fp, "Forge        %d\n", ch->pcdata->forge);
		fprintf (fp, "Darkness     %d\n", ch->pcdata->darkness);
		fprintf (fp, "Shadeandspirit   %d\n", ch->pcdata->shadeandspirit);
		...
		fprintf (fp, "Animalism    %d\n", ch->pcdata->animalism);
		fprintf (fp, "Repair       %d\n", ch->pcdata->repair);
		fprintf (fp, "Teach        %d\n", ch->pcdata->teach);
		fprintf (fp, "Learn        %d\n", ch->pcdata->learn);
		fprintf (fp, "Notes        %d\n", ch->pcdata->notes);
		fprintf (fp, "Evileye      %d\n", ch->pcdata->evileye);
		fprintf (fp, "ForageTime   %d\n", ch->pcdata->foragetime);
		fprintf (fp, "HuntTime     %d\n", ch->pcdata->hunttime);
		fprintf (fp, "PayTime     %d\n", ch->pcdata->paytime);
		fprintf (fp, "Clarity      %d %d\n", ch->pcdata->clarity[0], ch->pcdata->clarity[1]);
		...
		fprintf (fp, "Merit        %d %d %d %d %d %d %d %d %d %d %d\n", ch->pcdata->merit[0], ch->pcdata->merit[1], ch->pcdata->merit[2], ch->pcdata->merit[3], ch->pcdata->merit[4], ch->pcdata->merit[5], ch->pcdata->merit[6], ch->pcdata->merit[7], ch->pcdata->merit[8], ch->pcdata->merit[9], ch->pcdata->merit[10]);
		...
		fprintf (fp, "Bloodlinedisc%d %d %d\n", ch->pcdata->bloodlined[0], ch->pcdata->bloodlined[1], ch->pcdata->bloodlined[2]);
		...
		fprintf (fp, "Organizations      %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d\n",
			 ch->pcdata->organizations[0], ch->pcdata->organizations[1], ch->pcdata->organizations[2], ch->pcdata->organizations[3], ch->pcdata->organizations[4], ch->pcdata->organizations[5], ch->pcdata->organizations[6], ch->pcdata->organizations[7], ch->pcdata->organizations[8], ch->pcdata->organizations[9], ch->pcdata->organizations[10], ch->pcdata->organizations[11], ch->pcdata->organizations[12], ch->pcdata->organizations[13], ch->pcdata->organizations[14], ch->pcdata->organizations[15], ch->pcdata->organizations[16], ch->pcdata->organizations[17], ch->pcdata->organizations[18], ch->pcdata->organizations[19]);
		...
		fprintf (fp, "Eternalspring      %d\n", ch->pcdata->eternalspring);
		...
		fprintf (fp, "Physical     ");
		for (i = 0; i < MAX_TAL; i++)
			fprintf (fp, " %d", ch->abilities[PHYSICAL][i]);
		fprintf (fp, "\n");

		fprintf (fp, "Social      ");
		for (i = 0; i < MAX_SKI; i++)
			fprintf (fp, " %d", ch->abilities[SOCIAL][i]);
		fprintf (fp, "\n");

		fprintf (fp, "Mental  ");
		for (i = 0; i < MAX_KNO; i++)
			fprintf (fp, " %d", ch->abilities[MENTAL][i]);
		fprintf (fp, "\n");
...
/* Lumi Code*/
	...
	if (ch->pcdata->roomdesc != NULL)
		fprintf (fp, "RDS %s~\n", ch->pcdata->roomdesc);	
	if (ch->pcdata->miendesc != NULL)
		fprintf (fp, "MND %s~\n", ch->pcdata->miendesc);	
/* End */
/* Finger elements test */
	if (ch->pcdata->surname != NULL)
		fprintf (fp, "TEH %s~\n", ch->pcdata->surname);	
	if (ch->pcdata->wiki != NULL)
		fprintf (fp, "WIK %s~\n", ch->pcdata->wiki);
	if (ch->pcdata->pref != NULL)
		fprintf (fp, "PEF %s~\n", ch->pcdata->pref);	
	if (ch->pcdata->reputation != NULL)
...
/* End finger tests */
  ...
  if (strlen (ch->kithname) > 1)
	...
	if (strlen (ch->courtname) > 1)
		fprintf (fp, "LOD %s~\n", ch->courtname);
	if (strlen (ch->virtue) > 1)
		fprintf (fp, "NTR %s~\n", ch->virtue);
	if (strlen (ch->vice) > 1)
		fprintf (fp, "DNR %s~\n", ch->vice);
	if (strlen (ch->lodge) > 1)
		fprintf (fp, "ORD %s~\n", ch->lodge);
...
//	fprintf (fp, "LVT %d %d %d\n", ch->pcdata->last_vote_time.year, ch->pcdata->last_vote_time.month, ch->pcdata->last_vote_time.day);
   ...
   if (IS_VAMPIRE (ch) || IS_MORTAL(ch))
	...
	fprintf (fp, "RDT %d\n", ch->pcdata->clant);
	if (IS_CHANGELING (ch))
		fprintf (fp, "VRT %d %d %d %d %d\n", ch->pcdata->virtues[VIRTUE_CITYSTATUS], ch->pcdata->virtues[VIRTUE_COVSTATUS], ch->pcdata->virtues[VIRTUE_CLANSTATUS], ch->pcdata->virtues[VIRTUE_VISION], ch->pcdata->virtues[VIRTUE_MANTLE]);
...
//	fprintf (fp, "AVC %d\n", ch->pcdata->auto_vote_counter);
	...
	{
		if (strlen (ch->pcdata->urhandescshort) > 1 )
			fprintf (fp, "SDL %s~\n", ch->pcdata->urhandescshort);
		if (strlen (ch->pcdata->gaurudescshort) > 1 )
			fprintf (fp, "SDC %s~\n", ch->pcdata->gaurudescshort);
		if (strlen (ch->pcdata->urshuldescshort) > 1 )
			fprintf (fp, "SDH %s~\n", ch->pcdata->urshuldescshort);
		if (strlen (ch->pcdata->daludescshort) > 1 )
			fprintf (fp, "SDG %s~\n", ch->pcdata->daludescshort);
		if (strlen (ch->pcdata->urhandesc) > 1)
			fprintf (fp, "LDD %s~\n", ch->pcdata->urhandesc);
		if (strlen (ch->pcdata->gaurudesc) > 1)
			fprintf (fp, "CDD %s~\n", ch->pcdata->gaurudesc);

		if (strlen (ch->pcdata->urshuldesc) > 1)
			fprintf (fp, "HDD %s~\n", ch->pcdata->urshuldesc);
		if (strlen (ch->pcdata->daludesc) > 1)
			fprintf (fp, "GDD %s~\n", ch->pcdata->daludesc);
		if (strlen (ch->pcdata->tempdesc) > 1)
			fprintf (fp, "TDC %s~\n", ch->pcdata->tempdesc);
		if (strlen (ch->pcdata->biography) > 1)
			fprintf (fp, "BIO %s~\n", ch->pcdata->biography);
		if (ch->pcdata->noble)
			fprintf (fp, "NBL %d\n", ch->pcdata->noble);
		...
		if (strlen (ch->pcdata->giftlist) > 1)
			fprintf (fp, "GFL %s~\n", ch->pcdata->giftlist);
		if (strlen (ch->pcdata->mlongdesc) > 1)
			fprintf (fp, "MLD %s~\n", ch->pcdata->mlongdesc);
		...
		fprintf (fp, "TLX");
		for (i = 0; i < MAX_TAL; i++)
			fprintf (fp, " %d", ch->pcdata->abilities_points[PHYSICAL][i]);
		fprintf (fp, "\n");
		...
		fprintf (fp, "SKX");
		for (i = 0; i < MAX_SKI; i++)
			fprintf (fp, " %d", ch->pcdata->abilities_points[SOCIAL][i]);
		fprintf (fp, "\n");
		...
		fprintf (fp, "KNX");
		for (i = 0; i < MAX_KNO; i++)
			fprintf (fp, " %d", ch->pcdata->abilities_points[MENTAL][i]);
		fprintf (fp, "\n");
		fprintf (fp, "PSW %s~\n", ch->pcdata->pwd);
		if (IS_IMMORTAL(ch))
		{
		...
		if (str_cmp (ch->pcdata->cot_time, "None"))
			fprintf (fp, "C_T %s~\n", ch->pcdata->cot_time);
		if (str_cmp (ch->pcdata->cot_bloodlines, "All"))
			fprintf (fp, "C_C %s~\n", ch->pcdata->cot_bloodlines);
		...
		if (ch->pcdata->rank)
			fprintf (fp, "RNK %d\n", ch->pcdata->rank);
		if (ch->pcdata->courtname)
			fprintf (fp, "FAI %d\n", ch->pcdata->courtname);
		if (IS_CHANGELING(ch))
		{
			fprintf (fp, "CNV %d %d\n", ch->pcdata->harmony[HARMONY_CURRENT], ch->pcdata->harmony[HARMONY_MAX]);
			
			if (ch->pcdata->harmony_bank)
				fprintf (fp, "CVB %d\n", ch->pcdata->harmony_bank);						
		}
		...
		if (ch->pcdata->atm)
			fprintf (fp, "ATM %d\n", ch->pcdata->atm);
		if (ch->pcdata->eternalsummer)
			fprintf (fp, "NEC %d\n", ch->pcdata->eternalsummer);
		if (ch->pcdata->forge)
			fprintf (fp, "OBE %d\n", ch->pcdata->forge);
		if (ch->pcdata->darkness)
			fprintf (fp, "DRK %d\n", ch->pcdata->darkness);
		if (ch->pcdata->shadeandspirit)
			fprintf (fp, "TPR %d\n", ch->pcdata->shadeandspirit);
		if (ch->pcdata->moon)
			fprintf (fp, "D_M %d\n", ch->pcdata->moon);
		...
		if (ch->pcdata->conjure)
			fprintf (fp, "CJR %d\n", ch->pcdata->conjure);
		if (ch->pcdata->animalism)
			fprintf (fp, "CEL %d\n", ch->pcdata->animalism);
		if (ch->pcdata->evileye)
			fprintf (fp, "EVE %d\n", ch->pcdata->evileye);
		if (ch->pcdata->foragetime)
			fprintf (fp, "FRT %d\n", ch->pcdata->foragetime);
		if (ch->pcdata->hunttime)
			fprintf (fp, "HTI %d\n", ch->pcdata->hunttime);
		if (ch->pcdata->paytime)
			fprintf (fp, "PAY %d\n", ch->pcdata->paytime);
    if (ch->pcdata->clarity[0] != 1 || ch->pcdata->clarity[1] != 1)
			fprintf (fp, "HAR %d %d\n", ch->pcdata->clarity[0], ch->pcdata->clarity[1]);
		...
		if (ch->pcdata->bloodlined[0] | ch->pcdata->bloodlined[1] | ch->pcdata->bloodlined[2])
		...
		if (IS_CHANGELING (ch))
		{
			...
			fprintf (fp, "TRB %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d\n",
				 ch->pcdata->organizations[0], ch->pcdata->organizations[1], ch->pcdata->organizations[2],
				 ch->pcdata->organizations[3], ch->pcdata->organizations[4], ch->pcdata->organizations[5], ch->pcdata->organizations[6], ch->pcdata->organizations[7], ch->pcdata->organizations[8], ch->pcdata->organizations[9], ch->pcdata->organizations[10], ch->pcdata->organizations[11], ch->pcdata->organizations[12], ch->pcdata->organizations[13], ch->pcdata->organizations[14], ch->pcdata->organizations[15], ch->pcdata->organizations[16], ch->pcdata->organizations[17], ch->pcdata->organizations[18], ch->pcdata->organizations[19]);
...
void fwrite_obj (CHAR_DATA * ch, OBJ_DATA * obj, FILE * fp, int iNest)
{
	...
	fprintf (fp, "ShortDescr   %s~\n", obj->short_descr);
	fprintf (fp, "Description  %s~\n", obj->description);
	if (obj->inside_desc != NULL && strlen (obj->inside_desc) > 1 && str_cmp (obj->inside_desc, "(null)"))
		fprintf (fp, "Poweronch    %s~\n", obj->inside_desc);
	if (obj->outside_desc != NULL && strlen (obj->outside_desc) > 1 && str_cmp (obj->outside_desc, "(null)"))
...
//	ch->pcdata->last_vote_time.day = 0;
	...
	ch->pcdata->urhandescshort = str_dup ("");
	ch->pcdata->gaurudescshort = str_dup ("");
	ch->pcdata->urshuldescshort = str_dup ("");
	ch->pcdata->daludescshort = str_dup ("");
	...
	ch->pcdata->cot_bloodlines = str_dup ("All");
...
/* Aura Code */
	...
	ch->pcdata->miendesc = str_dup ("");
/* Finger elements test */
	ch->pcdata->surname = str_dup ("");
	ch->pcdata->wiki = str_dup ("");
	ch->pcdata->pref = str_dup ("");
	ch->pcdata->reputation = str_dup ("");
/* End finger test */
	ch->pcdata->show_social = FALSE;
	ch->pcdata->urhandesc = str_dup ("");
	ch->pcdata->gaurudesc = str_dup ("");
	ch->pcdata->urshuldesc = str_dup ("");
	ch->pcdata->daludesc = str_dup ("");
	ch->pcdata->mlongdesc = str_dup ("");
	ch->pcdata->tempdesc = str_dup ("");
	ch->pcdata->biography = str_dup ("");
	ch->pcdata->showtempdesc = FALSE;
	ch->pcdata->giftlist = str_dup ("");
	ch->lord = str_dup ("");
	ch->bloodline = str_dup ("");
	ch->side = str_dup ("");
	ch->kithname = str_dup ("");
	ch->auspice = str_dup ("");
	ch->courtname = str_dup ("");
	ch->virtue = str_dup("");
	ch->vice = str_dup("");
	ch->lodge = str_dup("");
	ch->impulse = str_dup("");
	...
	ch->truebeast = 20;
	ch->autostance = 0;
	ch->pcdata->virtues[VIRTUE_CITYSTATUS] = 1;
	ch->pcdata->virtues[VIRTUE_COVSTATUS] = 1;
	ch->pcdata->virtues[VIRTUE_CLANSTATUS] = 1;
	if (IS_CHANGELING(ch))
	{
		ch->pcdata->virtues[VIRTUE_VISION] = 1;
		ch->pcdata->virtues[VIRTUE_MANTLE] = 1;
	}
	ch->loc_hp[0] = 0;
	ch->loc_hp[1] = 0;
	ch->loc_hp[2] = 0;
...
//	ch->pcdata->auto_vote_counter = 0;
	...
	ch->pcdata->wolf = 0;
	ch->pcdata->rank = 0;
	ch->pcdata->courtname = 0;
	if (IS_WEREWOLF(ch))
	{
		ch->pcdata->harmony[HARMONY_CURRENT] = 0;
		ch->pcdata->harmony[HARMONY_MAX] = 0;
		ch->pcdata->harmony_bank = 0;
	}
	ch->pcdata->regenerate = 0;
	ch->pcdata->demonic = 0;
	ch->pcdata->atm = 0;
	ch->pcdata->song = 0;
	ch->pcdata->eternalsummer = 0;
	ch->pcdata->forge = 0;
	...
	ch->pcdata->spirit = 0;
	ch->pcdata->conjure = 0;
	ch->pcdata->animalism = 0;
	ch->pcdata->repair = 0;
	ch->pcdata->teach = 0;
	ch->pcdata->learn = 0;
	ch->pcdata->notes = 0;
	ch->pcdata->evileye = 0;
	ch->pcdata->foragetime = 0;
	ch->pcdata->hunttime = 0;
	ch->pcdata->paytime = 0;
	ch->pcdata->followers = 0;
	ch->pcdata->clarity[0] = 1;
	ch->pcdata->clarity[1] = 1;
	...
	ch->pcdata->bloodlined[0] = 0;
	ch->pcdata->bloodlined[1] = 0;
	ch->pcdata->bloodlined[2] = 0;
	...
	ch->pcdata->breed[1] = 0;
	ch->pcdata->breed[2] = 0;
	ch->pcdata->organizations[0] = 0;
	ch->pcdata->organizations[1] = 0;
	ch->pcdata->organizations[2] = 0;
	ch->pcdata->organizations[3] = 0;
	ch->pcdata->organizations[4] = 0;
	ch->pcdata->organizations[5] = 0;
	ch->pcdata->organizations[6] = 0;
	ch->pcdata->organizations[7] = 0;
	ch->pcdata->organizations[8] = 0;
	ch->pcdata->organizations[9] = 0;
	ch->pcdata->organizations[10] = 0;
	ch->pcdata->organizations[11] = 0;
	ch->pcdata->organizations[12] = 0;
	ch->pcdata->organizations[13] = 0;
	ch->pcdata->organizations[14] = 0;
	ch->pcdata->organizations[15] = 0;
	ch->pcdata->organizations[16] = 0;
	ch->pcdata->organizations[17] = 0;
	ch->pcdata->organizations[18] = 0;
	ch->pcdata->organizations[19] = 0;
	...
	/* Merits/Specs Stuff */
	ch->pcdata->merits = (char **)malloc(sizeof(char *) * 50); // 50 Spots for Merits
	ch->pcdata->spec = (char **)malloc(sizeof(char *) * 50); // 50 Spots for Spec
	ch->pcdata->style = (char **)malloc(sizeof(char *) * 50); // 50 Spots for Fighting Styles
	ch->pcdata->enote = (char **)malloc(sizeof(char *) * 50); // 50 Spots for EQ Notes
	ch->pcdata->pnote = (char **)malloc(sizeof(char *) * 50); // 50 Spots for Pledge Notes

	for (i = 0; i < 10; i++)
	{
		ch->pcdata->merits[i] = NULL;
		ch->pcdata->spec[i] = NULL;
		ch->pcdata->style[i] = NULL;
		ch->pcdata->enote[i] = NULL;
		ch->pcdata->pnote[i] = NULL;
	}
	/* End Merits/Specs Stuff */
...
/* End finger */
	...
	ch->pcdata->extra = NULL;
        ...
        /* Merits/Specs Stuff */
        ch->pcdata->merits = (char **)malloc(sizeof(char *) * 50); // 50 Spots for Merits
        ch->pcdata->spec = (char **)malloc(sizeof(char *) * 50); // 50 Spots for Specs
        ch->pcdata->style = (char **)malloc(sizeof(char *) * 50); // 50 Spots for Fighting Styles
        ch->pcdata->enote = (char **)malloc(sizeof(char *) * 50); // 50 Spots for Equipment Notes
        ch->pcdata->pnote = (char **)malloc(sizeof(char *) * 50); // 50 Spots for Pledge Notes
...
//	int merit_ctr = 0;
	...
	for (;;)
	{
		...
		case 'A':
			...
			KEY ("AUS", ch->auspice, fread_string (fp));
			KEY ("Auspice", ch->auspice, fread_string (fp));
//			KEY ("AutoVote", ch->pcdata->auto_vote_counter, fread_number(fp));
		...
		case 'B':
			...
			KEY ("Biography", ch->pcdata->biography, fread_string (fp));
		...
		case 'C':
			KEY ("GauruDesc", ch->pcdata->gaurudesc, fread_string (fp));
			KEY ("Animalism", ch->pcdata->animalism, fread_number (fp));
			KEY ("Bloodline", ch->bloodline, fread_string (fp));
			if (!str_cmp (word, "Bloodlinedisc"))
			{
				ch->pcdata->bloodlined[0] = fread_number (fp);
				ch->pcdata->bloodlined[1] = fread_number (fp);
				ch->pcdata->bloodlined[2] = fread_number (fp);
				fMatch = TRUE;
				break;
			}
			...
			if (IS_WEREWOLF(ch))
			{
				if (!str_cmp (word, "Harmony"))
				{
					ch->pcdata->harmony[HARMONY_CURRENT] = fread_number (fp);
					ch->pcdata->harmony[HARMONY_MAX] = fread_number (fp);
					fMatch = TRUE;
					break;
				}
				KEY ("HarmonyBank", ch->pcdata->harmony_bank, fread_number (fp));
			}
			...
			KEY ("CotBloodlines", ch->pcdata->cot_bloodlines, fread_string (fp));
		...
		case 'D':
			...
			KEY ("Vice", ch->vice, fread_string (fp));
			KEY ("Moon", ch->pcdata->moon, fread_number (fp));

			if (!str_cmp (word, "Disc")) // Check done
			{
		...
		case 'F':
		    KEY ("ForageTime", ch->pcdata->foragetime, fread_number (fp));
			KEY ("Courtname", ch->pcdata->courtname, fread_number (fp));
			...
			if (!str_cmp (word, "Spec"))
			{
                                ...
                                ch->pcdata->spec[spec_ctr] = (char *)malloc(sizeof(char) * strlen(temp_string));
                                ch->pcdata->spec[spec_ctr++] = strdup(temp_string);
                                fMatch = TRUE;
                                break;
			}
			/* End Merits/Specs Stuff */
		...
		case 'G':
			...
			KEY ("DaluDesc", ch->pcdata->daludesc, fread_string (fp));
...
/*			if (!str_cmp (word, "Wyrd"))
			{
				ch->pcdata->wyrd[0] = fread_number (fp);
				ch->pcdata->wyrd[1] = fread_number (fp);
				fMatch = TRUE;
				break;
			}*/
			KEY ("Pounds", ch->pounds, fread_number (fp));
			KEY ("Gpoints", ch->pcdata->gpoints, fread_number (fp));
			break;

		case 'H':
		    KEY ("HuntTime", ch->pcdata->hunttime, fread_number (fp));
			KEY ("UrshulDesc", ch->pcdata->urshuldesc, fread_string (fp));
		...
		case 'L':
			KEY ("UrhanDesc", ch->pcdata->urhandesc, fread_string (fp));
...
/*			if( !str_cmp( word, "Lastvotetime" ) )
      ...
      KEY ("Courtname", ch->courtname, fread_string (fp));
		...
		case 'M':
			KEY ("Eternalspring", ch->pcdata->eternalspring, fread_number (fp));
			...
			if (!str_cmp (word, "Merit"))
			{
				ch->pcdata->merit[0] = fread_number (fp);
				ch->pcdata->merit[1] = fread_number (fp);
				ch->pcdata->merit[2] = fread_number (fp);
				ch->pcdata->merit[3] = fread_number (fp);
				ch->pcdata->merit[4] = fread_number (fp);
				ch->pcdata->merit[5] = fread_number (fp);
				ch->pcdata->merit[6] = fread_number (fp);
				ch->pcdata->merit[7] = fread_number (fp);
				ch->pcdata->merit[8] = fread_number (fp);
				ch->pcdata->merit[9] = fread_number (fp);
				ch->pcdata->merit[10] = fread_number (fp);
				fMatch = TRUE;
				break;
			}
			
			KEY ("MLongDesc", ch->pcdata->mlongdesc, fread_string (fp));
		...
		case 'N':
			...
			KEY ("Virtue", ch->virtue, fread_string (fp));
			KEY ("Notes", ch->pcdata->notes, fread_number (fp));
			KEY ("Eternalsummer", ch->pcdata->eternalsummer, fread_number (fp));
			break;

		case 'O':
			KEY ("forge", ch->pcdata->forge, fread_number (fp));
			KEY ("Objvnum", ch->pcdata->obj_vnum, fread_number (fp));
			KEY ("Lodge", ch->lodge, fread_string (fp));
			break;

		case 'P':
			KEY ("Parents", ch->pcdata->parents, fread_string (fp));
			KEY ("Password", ch->pcdata->pwd, fread_string (fp));
            KEY ("PayTime", ch->pcdata->paytime, fread_number (fp));
...
/*			if (!str_cmp (word, "Glamour"))
			{
				ch->pcdata->glamour[0] = fread_number (fp);
				ch->pcdata->glamour[1] = fread_number (fp);
				fMatch = TRUE;
				break;
			}*/
		...
		case 'S':
			...
			KEY ("ShortDescC", ch->pcdata->gaurudescshort, fread_string (fp));
			KEY ("ShortDescG", ch->pcdata->daludescshort, fread_string (fp));
			KEY ("ShortDescH", ch->pcdata->urshuldescshort, fread_string (fp));
			KEY ("ShortDescL", ch->pcdata->urhandescshort, fread_string (fp));
			...
			if (!str_cmp (word, "Style"))
			{
                                temp_string = fread_string (fp);
                                ch->pcdata->style[style_ctr] = (char *)malloc(sizeof(char) * strlen(temp_string));
                                ch->pcdata->style[style_ctr++] = strdup(temp_string);
                                fMatch = TRUE;
                                break;
			}
			if (!str_cmp (word, "Enote"))
			{
                                temp_string = fread_string (fp);
                                ch->pcdata->enote[enote_ctr] = (char *)malloc(sizeof(char) * strlen(temp_string));
                                ch->pcdata->enote[enote_ctr++] = strdup(temp_string);
                                fMatch = TRUE;
                                break;
			}
			...
			{
                                temp_string = fread_string (fp);
                                ch->pcdata->pnote[pnote_ctr] = (char *)malloc(sizeof(char) * strlen(temp_string));
                                ch->pcdata->pnote[pnote_ctr++] = strdup(temp_string);
                                fMatch = TRUE;
                                break;
			}
		...
		case 'T':
			...
			KEY ("Shadeandspirit", ch->pcdata->shadeandspirit, fread_number (fp));
			KEY ("TempDesc", ch->pcdata->tempdesc, fread_string (fp));
			if (!str_cmp (word, "Organizations"))
			{
				ch->pcdata->organizations[0] = fread_number (fp);
				ch->pcdata->organizations[1] = fread_number (fp);
				ch->pcdata->organizations[2] = fread_number (fp);
				ch->pcdata->organizations[3] = fread_number (fp);
				ch->pcdata->organizations[4] = fread_number (fp);
				ch->pcdata->organizations[5] = fread_number (fp);
				ch->pcdata->organizations[6] = fread_number (fp);
				ch->pcdata->organizations[7] = fread_number (fp);
				ch->pcdata->organizations[8] = fread_number (fp);
				ch->pcdata->organizations[9] = fread_number (fp);
				ch->pcdata->organizations[10] = fread_number (fp);
				ch->pcdata->organizations[11] = fread_number (fp);
				ch->pcdata->organizations[12] = fread_number (fp);
				ch->pcdata->organizations[13] = fread_number (fp);
				ch->pcdata->organizations[14] = fread_number (fp);
				ch->pcdata->organizations[15] = fread_number (fp);
				ch->pcdata->organizations[16] = fread_number (fp);
				ch->pcdata->organizations[17] = fread_number (fp);
				ch->pcdata->organizations[18] = fread_number (fp);
				ch->pcdata->organizations[19] = fread_number (fp);
				fMatch = TRUE;
				break;
			}
      ...
      KEY ("Kithname", ch->kithname, fread_string (fp));
		...
		case 'V':
			KEY ("Po", ch->pcdata->po, fread_number (fp));
			KEY ("Vampaff", ch->vampaff, fread_number (fp));
			KEY ("Vamppot", ch->vamppot, fread_number (fp));
			KEY ("Vamppass", ch->vamppass, fread_number (fp));
			if (!str_cmp (word, "Virtues"))
			{
				if (IS_CHANGELING(ch))
				{
					ch->pcdata->virtues[VIRTUE_CITYSTATUS] = fread_number(fp);
					ch->pcdata->virtues[VIRTUE_COVSTATUS] = fread_number(fp);
					ch->pcdata->virtues[VIRTUE_CLANSTATUS] = fread_number(fp);
					ch->pcdata->virtues[VIRTUE_VISION] = fread_number(fp);
					ch->pcdata->virtues[VIRTUE_MANTLE] = fread_number(fp);
				}
				else
				{
					ch->pcdata->virtues[VIRTUE_CITYSTATUS] = fread_number(fp);
...
//			KEY ("AVC", ch->pcdata->auto_vote_counter, fread_number (fp));
		...
		case 'B':
			...
			KEY ("BIO", ch->pcdata->biography, fread_string (fp));
		...
		case 'C':
			KEY ("CDD", ch->pcdata->gaurudesc, fread_string (fp));
			KEY ("C_L", ch->pcdata->leader, fread_string (fp));
			KEY ("CEL", ch->pcdata->animalism, fread_number (fp));
...
//			KEY ("CVC", ch->pcdata->canvotecounter, fread_number (fp));
			...
			KEY ("CLN", ch->bloodline, fread_string (fp));
			if (!str_cmp (word, "CLD"))
			{
				ch->pcdata->bloodlined[0] = fread_number (fp);
				ch->pcdata->bloodlined[1] = fread_number (fp);
      ...
      break;
			...
			KEY ("C_C", ch->pcdata->cot_bloodlines, fread_string (fp));
			...
			if (IS_WEREWOLF(ch))
				KEY ("CVB", ch->pcdata->harmony_bank, fread_number (fp));
			break;

		case 'D':
			KEY ("D_M", ch->pcdata->moon, fread_number (fp));
      ...
      break;
			...
			buf=one_argument_retain_cap(buf, arg1);
			buf=one_argument_retain_cap(buf, arg2);
			buf=one_argument_retain_cap(buf, arg3);

			add_extra_node(ch, arg1, arg2, atoi(arg3));
		...
		case 'F':
		    KEY ("FRT", ch->pcdata->foragetime, fread_number (fp));
			KEY ("FAI", ch->pcdata->courtname, fread_number (fp));
			if (!str_cmp (word, "FK1"))
			{
				ch->pcdata->fake_skill = fread_number (fp);
				ch->pcdata->fake_stance = fread_number (fp);
		...
		case 'G':
			...
			KEY ("GDD", ch->pcdata->daludesc, fread_string (fp));
			if (!str_cmp (word, "GNS"))
			{
				ch->pcdata->genes[0] = fread_number (fp);
				ch->pcdata->genes[1] = fread_number (fp);
...
/*			if (!str_cmp (word, "GNO"))
			...
			KEY ("GLD", ch->pounds, fread_number (fp));
			KEY ("GPT", ch->pcdata->gpoints, fread_number (fp));
			break;

		case 'H':
			KEY ("HDD", ch->pcdata->urshuldesc, fread_string (fp));
			if (!str_cmp (word, "HAR"))
			{
				ch->pcdata->clarity[0] = fread_number (fp);
				ch->pcdata->clarity[1] = fread_number (fp);
				fMatch = TRUE;
				break;
			}
			KEY ("HTI", ch->pcdata->hunttime, fread_number (fp));
		...
		case 'K':
			...
			{
				for (i = 0; i < 10; i++)
					ch->abilities[MENTAL][i] = fread_number (fp);
				fMatch = TRUE;
				break;
			}
			if (!str_cmp (word, "KNX"))
			{
				for (i = 0; i < 10; i++)
					ch->pcdata->abilities_points[MENTAL][i] = fread_number (fp);
				fMatch = TRUE;
				break;
			}
			break;
		...
		case 'L':
			KEY ("LDD", ch->pcdata->urhandesc, fread_string (fp));
...
//  			  ch->pcdata->last_vote_time.day = fread_number( fp );
			...
			KEY ("LOD", ch->courtname, fread_string (fp));
			KEY ("LRD", ch->lord, fread_string (fp));
			KEY ("LOV", ch->pcdata->love, fread_string (fp));
			break;

		case 'M':
			KEY ("MAJ", ch->pcdata->eternalspring, fread_number (fp));
			/* Remember Stuff */
			if (!str_cmp (word, "MEM"))
			{
      ...
      KEY ("MND", ch->pcdata->miendesc, fread_string (fp));
      KEY ("MLD", ch->pcdata->mlongdesc, fread_string (fp));
			/* Merits/Specs Stuff */
			/*if (!str_cmp (word, "MRT"))
			{
                                temp_string = fread_string (fp);
		...
		case 'N':
			...
			KEY ("NEC", ch->pcdata->eternalsummer, fread_number (fp));
			KEY ("NBL", ch->pcdata->noble, fread_number (fp));
			KEY ("NTR", ch->virtue, fread_string (fp));
			break;

		case 'O':
			KEY ("OBE", ch->pcdata->forge, fread_number (fp));
			KEY ("OBV", ch->pcdata->obj_vnum, fread_number (fp));
			KEY ("ORD", ch->lodge, fread_string (fp));
			break;

		case 'P':
			if (!str_cmp (word, "PLS"))
			{
				ch->pcdata->plasm = fread_number (fp);
				fMatch = TRUE;
				break;
			}
		  ...
		  if(!str_cmp(word, "PTM"))
			...
			KEY ("PAY", ch->pcdata->paytime, fread_number (fp));
			KEY ("PLN", ch->plane, fread_number (fp));
			KEY ("POT", ch->vamppot, fread_number (fp));
			...
			/* Finger element */
			KEY ("PEF", ch->pcdata->pref, fread_string (fp)); 
			/* end finger element */
		...
		case 'R':
			...
			/* Finger element */
			KEY ("REP", ch->pcdata->reputation, fread_string (fp)); 
			/* end finger element */
...
/*			{
			...
			KEY ("ROD", ch->pcdata->clan, fread_number (fp));
			KEY ("RDT", ch->pcdata->clant, fread_number (fp));
		...
		case 'S':
			...
			KEY ("SEX", ch->sex, fread_number (fp));
			KEY ("SDC", ch->pcdata->gaurudescshort, fread_string (fp));
			KEY ("SDG", ch->pcdata->daludescshort, fread_string (fp));
			KEY ("SDH", ch->pcdata->urshuldescshort, fread_string (fp));
			KEY ("SDL", ch->pcdata->urhandescshort, fread_string (fp));
			...
			{
				for (i = 0; i < 10; i++)
					ch->abilities[SOCIAL][i] = fread_number (fp);
				fMatch = TRUE;
				break;
			}
			if (!str_cmp (word, "SKX"))
			{
				for (i = 0; i < 10; i++)
					ch->pcdata->abilities_points[SOCIAL][i] = fread_number (fp);
				fMatch = TRUE;
				break;
			}
			if (!str_cmp (word, "SKL"))
			...
			KEY ("SST", ch->pcdata->covenantstatus, fread_number (fp));
			if (!str_cmp (word, "STN"))
			{
				ch->stance[0] = fread_number (fp);
				ch->stance[1] = fread_number (fp);
      ...
      break;
		...
		case 'T':
			...
			{
				for (i = 0; i < 10; i++)
					ch->abilities[PHYSICAL][i] = fread_number (fp);
				fMatch = TRUE;
				break;
			}
			...
			{
				for (i = 0; i < 10; i++)
					ch->pcdata->abilities_points[PHYSICAL][i] = fread_number (fp);
				fMatch = TRUE;
				break;
			}
			KEY ("TPR", ch->pcdata->shadeandspirit, fread_number (fp));
			if (!str_cmp (word, "TRB"))
			{
				ch->pcdata->organizations[0] = fread_number (fp);
				ch->pcdata->organizations[1] = fread_number (fp);
			...
			/* Finger element */
			KEY ("TEH", ch->pcdata->surname, fread_string (fp)); 
			/* end finger element */
			KEY ("TRI", ch->kithname, fread_string (fp));
		...
		case 'V':
			KEY ("VSN", ch->pcdata->po, fread_number (fp));
...
//			KEY ("VOT", ch->pcdata->votes, fread_number (fp));
		...
		case 'W':
			...
			/* Finger element */
			KEY ("WIK", ch->pcdata->wiki, fread_string (fp)); 
			/* end finger element */
	...
	*obj = obj_zero;
	...
	for (;;)
	{
		...
		case 'P':
			...
			KEY ("Poweronch", obj->inside_desc, fread_string (fp));
			KEY ("Poweroffch", obj->outside_desc, fread_string (fp));
	...
	*obj = obj_zero;
	...
	for (;;)
	{
		...
		case 'P':
			...
			KEY ("PNC", obj->inside_desc, fread_string (fp));
			KEY ("PFC", obj->outside_desc, fread_string (fp));
...
void do_finger (CHAR_DATA * ch, char *argument)
{
	...
	if ((victim = get_char_finger (ch, argument)) != NULL)
	{
		...
		f_wiki  = victim->pcdata->wiki;
		f_surname  = victim->pcdata->surname;
		f_pref  = victim->pcdata->pref;
		f_reputation  = victim->pcdata->reputation;
	}
	else
	{
		...
		if ((fp = fopen (strsave, "r")) != NULL)
		{
			...
			while (!drop_out)
			{
				...
				case 'P':
					...
					KEY ("PEF", f_pref, fread_string (fp));
					KEY ("Pref", f_pref, fread_string (fp));
				...
				case 'R':
					...
					KEY ("REP", f_reputation, fread_string (fp));
					KEY ("Reputation", f_reputation, fread_string (fp));
				...
				case 'T':
					KEY ("TEH", f_surname, fread_string (fp));
					KEY ("Surname", f_surname, fread_string (fp));
					...
					break;
				case 'W':
					KEY ("WIK", f_wiki, fread_string (fp));
					KEY ("Wiki", f_wiki, fread_string (fp));
					break;
				}
				if (!fMatch)
					fread_to_eol (fp);
	...
	send_to_char ("#g.-----------------------------------------------------------------------------.#n\n\r", ch);
	send_to_char ("#g|  #n                   Innocence Lost #g:#n Character Profile                      #g|#n\n\r", ch);
  send_to_char ("#g|-----------------------------------------------------------------------------|#n\n\r", ch);
	sprintf (buf, "#g|  #nName:#w %-22s #nSurname:#w %s%-37s#g|#n\n\r", f_name, drop_out ? "" : "", f_surname);
	send_to_char (buf, ch);
	send_to_char ("#g|-----------------------------------------------------------------------------|#n\n\r", ch);
  sprintf (buf, "#g|  #nLast connected on#w %-40s                 #g|#n\n\r", f_lasttime);
	send_to_char (buf, ch);
	send_to_char ("#g|-----------------------------------------------------------------------------|\n\r", ch);
	sprintf (buf, "#g|#n  Sex#w: %-29s#n", f_sex == SEX_MALE ? "#wMale#n" : f_sex == SEX_FEMALE ? "#wFemale#n" : "#wNone#n");
	send_to_char (buf, ch);
	...
	{
	default:
		send_to_char ("#nStatus:#w Player   #n", ch);
		break;
	case LEVEL_AVATAR:
		send_to_char ("#nStatus:#w Player   #n", ch);
		break;
	...
	case LEVEL_STORYTELLER:
		send_to_char ("#nStatus:#w Staff    #n", ch);
		break;
	case LEVEL_BUILDER:
		send_to_char ("#nStatus:#w Staff    #n", ch);
		break;
	...
	case LEVEL_IMPLEMENTOR:
		send_to_char ("#nStatus:#w Admin.   #n", ch);
		break;
	}
	if (f_played > 0)
	...
	sprintf (buf, "#n       Hours Logged:#w %-6d #g|#n\n\r", f_played);
	send_to_char (buf, ch);
	send_to_char ("#g|-----------------------------------------------------------------------------|#n\n\r", ch);
	send_to_char ("#g)-------------------------------(#nGeneral Info#g)--------------------------------(#n\n\r", ch);
	sprintf (buf, "#g|#n ProfileURL:#w %-64s#g|#n\n\r", f_wiki);
	send_to_char (buf, ch);
	sprintf (buf, "#g|                                                                             |#n\n\r");
	send_to_char (buf, ch);
	sprintf (buf, "#g|#n Preference:#w %-64s#g|#n\n\r", f_pref);
	send_to_char (buf, ch);
    sprintf (buf, "#g|                                                                             |#n\n\r");
	send_to_char (buf, ch);
	sprintf (buf, "#g|#n Reputation:#w %-64s#g|#n\n\r", f_reputation);
	send_to_char (buf, ch);
	if (strlen (f_email) > 2 && (!IS_SET (f_extra, EXTRA_INVIS_EMAIL) || IS_IMMORTAL (ch)))
	{
		send_to_char ("#g)-----------------------------------------------------------------------------(#n\n\r", ch);
		sprintf (buf, "#g|#n Site Handle:#w %-51s            #g|#n\n\r", f_email);
		send_to_char (buf, ch);
		send_to_char ("#g'-----------------------------------------------------------------------------'#n\n\r", ch);
	}
	return;
