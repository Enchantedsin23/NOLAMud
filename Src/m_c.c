...
void do_mpstat( CHAR_DATA *ch, char *argument )
{
    ...
    sprintf( buf,
	"Lv: %d.  Class: %d.  Align: %d.  AC: %d.  Pounds: %d.  Exp: %d.\n\r",
	victim->level,       victim->class,        victim->alignment,
	GET_AC( victim ),    victim->pounds,         victim->exp );
    send_to_char( buf, ch );
...
void do_mppounds( CHAR_DATA *ch, char *argument )
{
